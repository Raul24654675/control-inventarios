...
export default function Profile() {
  ...
  function handlePasswordSubmit(event: FormEvent<HTMLFormElement>) {
    ...
    if (passwordForm.newPassword.length < 8) {
      setPasswordNotice({ tone: 'error', message: 'La nueva contraseña debe tener al menos 8 caracteres.' })
      return
    }

    if (passwordForm.newPassword !== passwordForm.confirmPassword) {
      setPasswordNotice({ tone: 'error', message: 'La confirmación no coincide con la nueva contraseña.' })
      return
    }

    setPasswordNotice({
      tone: 'success',
      message: 'Flujo visual listo. La conexión real con backend puede integrarse después sin cambiar esta UI.',
    })
        ...
        <aside className="profile-panel profile-side-panel">
          ...
          <div className="security-card highlight">
            ...
            <div>
              ...
              <p>Actualiza tu contraseña periódicamente y evita compartir sesiones activas.</p>
            </div>
          </div>
